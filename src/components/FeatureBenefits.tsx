...
const FeatureBenefits = () => {
  return (
    <section className="w-full py-12 md:py-16 bg-ordermatic-lightBlue">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <div className="bg-blue-100 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
              <Clock className="w-6 h-6 text-ordermatic-blue" />
            </div>
            <h3 className="font-bold mb-3">Easy to use</h3>
          ...
          <div className="text-center">
            <div className="bg-blue-100 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
              <MessageSquare className="w-6 h-6 text-ordermatic-blue" />
            </div>
            <h3 className="font-bold mb-3">Expertly Trained AI</h3>
            <p className="text-ordermatic-secondaryText">
          ...
          <div className="text-center">
            <div className="bg-blue-100 w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4">
              <BarChart3 className="w-6 h-6 text-ordermatic-blue" />
            </div>
            <h3 className="font-bold mb-3">Unified Dashboard</h3>
            <p className="text-ordermatic-secondaryText">
